...
# Output
my_output <- paste("/scratch/csm6hg/genomes/proteins_species/primary_transcripts/summary/","busco_figure.png",sep="/") 
my_width <- 20
my_height <- 15
my_unit <- "cm"
...
my_species <- c('pulexnam', 'pulexnam', 'pulexnam', 'pulexnam', 'tigriopus', 'tigriopus', 'tigriopus', 'tigriopus', 'penaeus', 'penaeus', 'penaeus', 'penaeus', 'sinensis', 'sinensis', 'sinensis', 'sinensis', 'galeata', 'galeata', 'galeata', 'galeata', 'magna', 'magna', 'magna', 'magna', 'carinata', 'carinata', 'carinata', 'carinata', 'pulexeuro', 'pulexeuro', 'pulexeuro', 'pulexeuro', 'melanogaster', 'melanogaster', 'melanogaster', 'melanogaster', 'pulicaria', 'pulicaria', 'pulicaria', 'pulicaria')
...
my_percentage <- c(88.2, 9.4, 0.5, 1.9, 90.5, 1.3, 2.6, 5.6, 80.8, 10.3, 2.7, 6.2, 94.7, 2.6, 0.8, 1.9, 91.7, 1.3, 1.0, 6.0, 84.5, 13.5, 0.2, 1.8, 91.8, 6.2, 0.2, 1.8, 81.6, 11.5, 2.5, 4.4, 98.9, 1.0, 0.0, 0.1, 87.8, 10.2, 0.5, 1.5)
my_values <- c(893, 95, 5, 20, 917, 13, 26, 57, 818, 104, 27, 64, 959, 26, 8, 20, 929, 13, 10, 61, 856, 137, 2, 18, 930, 63, 2, 18, 827, 116, 25, 45, 1002, 10, 0, 1, 889, 103, 5, 16)
